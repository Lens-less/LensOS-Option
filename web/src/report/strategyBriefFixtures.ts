...
export const validatedHistoryStrategyFixture: StrategyBriefStrategy = {
  ...
  legs: [
    {
      instrument_name: "BTC-25SEP26-125000-C",
      side: "SELL",
      quantity: 1,
    ...
    {
      instrument_name: "BTC-25SEP26-130000-C",
      side: "BUY",
      quantity: 1,
  ...
  entry: {
    ...
    minimum_net_credit: 365,
    currency: "USD",
    fees_included: true,
    slippage_included: true,
    cost_model_id: "frozen_costs:test",
    cost_config_hash: "test-costs-10-20-5-15",
    cost_breakdown: { entry_fees: 10, slippage_reserve: 20, legging_reserve: 5, settlement_reserve: 15 },
  },
  risk: {
    max_loss_per_unit: 4650,
    currency: "USD",
    breakevens: [125350],
  ...
  primary_reason_codes: ["COST_BUDGET_NOT_ABSOLUTE_LOSS_BOUND"],
  copy_recipe: [
    "STRATEGY: BEAR_CALL_CREDIT_SPREAD",
    "SELL 1 BTC-25SEP26-125000-C",
    "BUY  1 BTC-25SEP26-130000-C",
    "MIN NET CREDIT: 365 USD",
    "MODELLED LOSS BUDGET PER UNIT: 4650 USD",
    "FROZEN COSTS: ENTRY FEES 10 / SLIPPAGE 20 / LEGGING 5 / SETTLEMENT RESERVE 15 USD",
...
const watchStrategyFixture: StrategyBriefStrategy = {
  ...clone(validatedHistoryStrategyFixture),
...
export const strategyBriefFixture: StrategyBrief = {
  ...
  action: "WATCH",
  strategies: [clone(validatedHistoryStrategyFixture)],
  no_trade: {
    active: false,
    headline_zh: null,
    summary_zh: null,
